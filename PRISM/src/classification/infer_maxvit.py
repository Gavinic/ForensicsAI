...
model_state = torch.load(
    "../../models/classification/max_vit_8_forgery_fake_best.pth", map_location="cpu"
)
model = timm.create_model("maxvit_xlarge_tf_512.in21k_ft_in1k", pretrained=False)
...
df.to_csv("infer_result_testB_xlarge.csv", index=False)
