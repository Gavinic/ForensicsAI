...
cfg.merge_from_file("config/max_vit_base_forgery_fake.yaml")
...
print(model)
weight_path = "<BASE_PATH>/ckpts/maxvit_base_tf_512.in21k_ft_in1k.bin"
# weight_path = "<BASE_PATH>/hw/output/swsl_8_tianchi_attack/swsl_8_tianchi_attack_best.pth"
