...
parser.add_argument(
    "--detector_path",
    type=str,
    default="<BASE_PATH>/DeepfakeBench/training/config/detector/resnet34.yaml",
...
parser.add_argument(
    "--weights_path",
    type=str,
    default="<BASE_PATH>/benchmark_results/auc_draw/cnn_aug/resnet34_2023-05-20-16-57-22/test/FaceForensics++/ckpt_epoch_9_best.pth",
)
